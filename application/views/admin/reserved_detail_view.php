...
<section>
    ...
    <a href="<?php echo site_url() . '/admin/calendar'; ?>"><button type="button" class="btn btn-default btn-lg"><span class="glyphicon glyphicon-chevron-left" aria-hidden="true"></span> ย้อนกลับ</button></a> 
    &nbsp;
